...
\def\activeconfig{dataeng}  % Change this: ai, dataeng, platform, architect, dev

\ifthenelse{\equal{\activeconfig}{ai}}{%
	\include{configs/config_ai.tex}
}{%
	\ifthenelse{\equal{\activeconfig}{dataeng}}{%
		\include{configs/config_data_eng.tex}
	}{%
		\ifthenelse{\equal{\activeconfig}{platform}}{%
			\include{configs/config_platform_eng.tex}
		}{%
			\ifthenelse{\equal{\activeconfig}{architect}}{%
				\include{configs/config_sw_architekt.tex}
			}{
				\ifthenelse{\equal{\activeconfig}{dev}}{%
					\include{configs/config_sw_dev.tex}
				}{}%
			}%
		}%
	}%
